             ...
             success: function(data){
            	 var html="";
             		$.each(data,function(i,n){
             			html+="<a href='"+n.url+"' target='_blank'>"+n.title+"</a><p>"+n.shortContent+"</p>";
             		});
	...
	function search(){
		...
		$.ajax({
             ...
             success: function(data){
            	 	...
            	 	var html="<ul>";
             		$.each(data,function(i,n){
             			html+="<li>docId:"+n.other+"<a href='"+n.url+"'>"+n.title+"</a><p>"+n.content+"</p></li>";
             		});
             		html+="</ul>";
             		console.log(html);
  ...
  <body>
    	<div class="container">
				...
				<fieldset>
				    ...
				    <textarea id="keyword" placeholder="输入关键词查询" ></textarea>
